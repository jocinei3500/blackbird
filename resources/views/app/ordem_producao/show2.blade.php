...
<style>
    ...
    .text-value { color: #0f172a; font-size: 1.75rem; font-weight: 700; letter-spacing: -0.02em; }
    .text-sub { font-size: 0.875rem; color: #94a3b8; }
    ...
    .card-warning-border { border: 2px solid #fcd34d; }
    ...
    .icon-float {
        ...
        color: #64748b; background-color: #f8fafc; border: 1px solid #e2e8f0;
    }
    ...
    .btn-date-picker:hover { background: #f8fafc; }
    ...
    .badge-status.success { background-color: #ecfdf5; color: #10b981; border: 1px solid #d1fae5; }
    .badge-status.warning { background-color: #fffbeb; color: #f59e0b; border: 1px solid #fef3c7; }
    .badge-status.danger { background-color: #fef2f2; color: #ef4444; border: 1px solid #fee2e2; }
    ...
    .stoppage-card {
        ...
        padding: 1rem;
        border: 1px solid #f1f5f9;
        border-left-width: 4px; /* Borda grossa na esquerda */
        box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);
    }
    .stoppage-card.open { border-left-color: #f59e0b; }
    .stoppage-card.resolved { border-left-color: #10b981; }

    .stoppage-time { font-size: 0.75rem; color: #94a3b8; display: flex; align-items: center; gap: 0.5rem; margin-top: 0.25rem; }
</style>
    ...
    <div class="d-flex justify-content-between align-items-start mb-5">
        <div>
            ...
            <p class="mb-0 text-secondary">
                Visão geral da operação • {{ \Carbon\Carbon::now()->translatedFormat('d \d\e F \d\e Y') }}
            </p>
        </div>
        <div>
    ...
    <div class="row g-4 mb-5">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="dashboard-card card-warning-border">
                ...
                <button class="btn btn-sm btn-outline-warning w-100 fw-bold" style="border-radius: 8px;">Ver Detalhes</button>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-4">
                    <div class="equip-card" style="background-color: #fef2f2; border-color: #fee2e2;">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            ...
                            <span class="badge-status danger"><i class="fa-solid fa-screwdriver-wrench"></i> Manutenção</span>
                        </div>
                        <h6 class="fw-bold mb-0 text-dark">Escavadeira Volvo</h6>
                        <div class="small text-muted mb-3">ESC-002 • Volvo EC480</div>
                        <div class="d-flex justify-content-between align-items-center pt-2 border-top border-danger-subtle">
                            <span class="small text-secondary fw-semibold">Horímetro</span>
            ...
            <div class="d-flex flex-column gap-3">
                ...
                <div class="stoppage-card open">
                    <div class="d-flex justify-content-between align-items-start">
                        ...
                        <span class="badge bg-warning text-dark border border-warning-subtle rounded-pill" style="font-size: 0.7em;"><i class="fa-regular fa-clock"></i> Em aberto</span>
                    </div>
                ...
                <div class="stoppage-card resolved">
                    <div class="d-flex justify-content-between align-items-start">
                        ...
                        <span class="badge bg-soft-success text-success border border-success-subtle rounded-pill" style="font-size: 0.7em;"><i class="fa-solid fa-check"></i> Resolvido</span>
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        new Chart(ctxStop, {
            type: 'doughnut',
            data: {
                labels: ['Aguardando Peça', 'Manutenção Corretiva', 'Falta de Combustível', 'Manutenção Preventiva'],
                datasets: [{
